...
#| warning: false
# Define a function to generate the faceted plot
...
# Provide the data and age_groups to the function
data <- geo_regions_age_duty

# Generate and display the faceted plot
...
# Provide the data and referral_groups to the function
...
# Provide the data and ethnicity_groups to the function
...
# Provide the data and employment_groups to the function
